...
public class ModTags {
    ...
    public static class Items {
        public static final TagKey<Item> MYTHRIL_INGOTS = createCommonTag("mythril_ingot");
        public static final TagKey<Item> MYTHRIL_NUGGETS = createCommonTag("mythril_nugget");
